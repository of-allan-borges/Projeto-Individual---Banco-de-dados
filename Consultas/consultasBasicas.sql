...
INSERT INTO livro (titulo, editora, data_publicacao, quantidade_disponivel, id_local, quantidade_total) VALUES ('Dom Casmurro', 'Editora A', '1899-01-01', 5, 1, 10);
...
UPDATE usuario SET telefone = '(11) 99876-5432' WHERE id_usuario = 1;
...
INSERT INTO multa (id_funcionario_responsavel, id_usuario, valor, data_multa, status_multa, descricao) VALUES (2, 3, 50.00, '2025-01-12', 'Pendente', 'Multa por atraso no retorno do livro');

--Alterar o status de uma multa:
UPDATE multa SET status_multa = 'Pago', data_pagamento = '2025-01-13' WHERE id_multa = 1;

--Excluir uma multa:
DELETE FROM multa WHERE id_multa = 1;

-- Inserir um novo funcionário:
INSERT INTO funcionario (nome, cargo, data_contratacao, salario, email, telefone, id_biblioteca) VALUES ('Carlos Oliveira', 'Assistente', '2025-01-01', 3000.00, 'carlos@biblioteca.com', '(11) 99876-5432', 1);
